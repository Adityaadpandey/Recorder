...
const MeetLink: string = "https://meet.google.com/ark-auwn-mvq"
...
async function openMeet(driver: WebDriver) {
    ...
    try {
        ...
        await nameInput.sendKeys("Recorder");
...
async function startScreenshare(driver: WebDriver) {
    ...
    const response = await driver.executeScript(`
        ...
        //   60000 is the length of the recording in milliseconds [Set that value according to your needs]
